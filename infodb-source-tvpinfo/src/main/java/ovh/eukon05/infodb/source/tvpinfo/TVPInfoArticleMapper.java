...
class TVPInfoArticleMapper {
    ...
    static Article mapFromJson(JsonObject json, ArticleSourceInfo sourceInfo) {
        ...
        return new Article(id, sourceInfo.name(), title, url, imageUrl, publishedAt, Collections.emptyList());
    }
}
